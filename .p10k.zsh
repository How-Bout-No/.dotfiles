# edited
# Generated by Powerlevel10k configuration wizard on 2024-02-26 at 13:03 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=$POWERLEVEL9K_OS_ICON_BACKGROUND
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=22
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=$POWERLEVEL9K_OS_ICON_BACKGROUND
  # Default context color (no privileges, no SSH).
  # typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=3
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$POWERLEVEL9K_OS_ICON_FOREGROUND
  # typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=0
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=$POWERLEVEL9K_OS_ICON_BACKGROUND

  # Context format when running with privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%U%n@%M%u%b'
